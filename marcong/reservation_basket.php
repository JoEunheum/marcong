 ...
 $total_price = explode(' ', $total_array[0]);
 mysqli_close($con);
  ?>
  <!DOCTYPE html>
  <html lang="ko">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0,shrink-to-fit=no">
     ...
     <body>
       ...
       <div class="container">
             ...
             <tr>
               ...
               <td class="align-middle">
                 ...
                 for ($i=0; $i < count($menu); $i++) {
                   ...
                   <input id="<?php echo $i ?>"readonly class="text-center" type="text" name="price[]" value="<?php echo $price[$i]; ?>" style="width:150px; border:0 none;">
                   <br>
                   <?php
                 }
                  ?>
               ...
               <td class="align-middle">
                 <input id="total_price"readonly class="font-weight-bold text-center" type="text" name="total" value="<?php echo $total_price[0]; ?> 원" style="width:150px; border:0 none;">
               </td>
         ...
         <hr>
         <h4 class="text-right">결제금액 : <input readonly class="text-right text-danger font-weight-bold" id="total" type="text" name="" value="<?php echo $total_price[0]; ?> 원" style="width:150px; border:0 none;"></h4>
         <hr>
         <div class="row">
           <div class="col">
           </div>
           ...
           <div class="col text-center">
             <form method="post" action="payment.php">
               ...
               <input type="hidden" name="price_total" id="price_total" value="<?php echo $total_price[0]; ?>">
       ...
       $("#reservation_ok").click(function(){
         ...
         if(ok_check){
           ...
           IMP.request_pay({
             ...
             if ( rsp.success ) {
               var menuString = JSON.stringify(<?php echo json_encode($menu); ?>);
               var countString = JSON.stringify(<?php echo json_encode($item_count); ?>);
               $.ajax({
                   type:"POST",
                   url:"./reservation_basket_db.php",
                   ...
                   success : function(data){
                     ...
                     $.ajax({
                       type:"POST",
                       url : "./reservation_basket_del_db.php",
                       data : {email : email_head+"@"+email_foot , idnumber : <?php echo $idnumber; ?>, basket_time : "<?php echo $basket_time; ?>"},
                       success : function(data){
                         $("form").submit();
                       },
                       error : function(data){
